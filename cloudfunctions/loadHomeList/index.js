...
// 云函数入口函数
// the function takes the openid, num_articles and ex_articles
// {
//   openid: string
//   num_articles: int (max 50)
//   ex_articles: [article_id]
// }
// returns randomly last num of articles given the english level for the user
...
exports.main = async (event, context) => {
  ...
  // load the last 100 articles given the level
